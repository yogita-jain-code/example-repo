...
public class NqmLSBGradingActivity extends AppBaseActivity implements OnClickListener, OnCheckedChangeListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		parent = NqmLSBGradingActivity.this;
				...
				public void onClick(DialogInterface dialog, int id) {
					...
					*/	ObservationDetailsDAO observationDetailsDAOObj = new ObservationDetailsDAO();
						...
						if(result == 0 || result == -1 ) {
							...
							final Intent intent = new Intent(NqmLSBGradingActivity.this,StandardMenuActivity.class);
