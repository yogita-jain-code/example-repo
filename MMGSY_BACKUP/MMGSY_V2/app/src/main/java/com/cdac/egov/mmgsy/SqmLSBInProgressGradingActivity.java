...
public class SqmLSBInProgressGradingActivity extends AppBaseActivity implements OnClickListener, OnCheckedChangeListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		parent = SqmLSBInProgressGradingActivity.this;
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_sqm_in_progress_lsb_grading);
		...
		viewFlipper = (ViewFlipper) findViewById(R.id.sqmLSBInProgressGradingFormViewFlipper);
		nextBtn = (Button) findViewById(R.id.sqmLSBInProgressGradingFormNextBtnId);
        previousBtn = (Button) findViewById(R.id.sqmLSBInProgressGradingFormPrevBtnId);
        saveBtn = (Button) findViewById(R.id.sqmLSBInProgressGradingFormSaveBtn);
        cancelBtn = (Button) findViewById(R.id.sqmLSBInProgressGradingFormCancelBtn);
      ...
      //-------- Radio Button Events
        sqmLSBQualityArrangementRadioGroup  = (RadioGroup) findViewById(R.id.sqmLSBInProgressGradingFormQualityArrangementRadioGroup);
        sqmLSBFoundationStageIRadioGroup  = (RadioGroup) findViewById(R.id.sqmLSBInProgressGradingFormFoundationStageIRadioGroup);
        sqmLSBSubstructurestageIIRadioGroup = (RadioGroup) findViewById(R.id.sqmLSBInProgressGradingFormSubstructurestageIIRadioGroup);
        sqmLSBSuperstructurestageIIIRadioGroup = (RadioGroup) findViewById(R.id.sqmLSBInProgressGradingFormSuperstructurestageIIIRadioGroup);
        sqmLSBContractionjointRadioGroup = (RadioGroup) findViewById(R.id.sqmLSBInProgressGradingFormContractionjointRadioGroup);
        sqmLSBContractionjointSpacingRadioGroup = (RadioGroup) findViewById(R.id.sqmLSBInProgressGradingFormContractionjointSpacingRadioGroup);
        sqmLSBContractionjointCrossSectionRadioGroup = (RadioGroup) findViewById(R.id.sqmLSBInProgressGradingFormContractionjointCrossSectionRadioGroup);
        sqmLSBResultofloadtestRadioGroup = (RadioGroup) findViewById(R.id.sqmLSBInProgressGradingFormResultofloadtestRadioGroup);
        sqmLSBApproachesstageIIandIIIRadioGroup = (RadioGroup) findViewById(R.id.sqmLSBInProgressGradingFormApproachesstageIIandIIIRadioGroup);
        sqmLSBContractionjointCrossSectionEmbankmentRadioGroup = (RadioGroup) findViewById(R.id.sqmLSBInProgressGradingFormContractionjointCrossSectionEmbankmentRadioGroup);
        sqmLSBContractionjointCrossSectionSubbaseRadioGroup = (RadioGroup) findViewById(R.id.sqmLSBInProgressGradingFormContractionjointCrossSectionSubbaseRadioGroup);
        sqmLSBContractionjointCrossSectionBasecourseRadioGroup = (RadioGroup) findViewById(R.id.sqmLSBInProgressGradingFormContractionjointCrossSectionBasecourseRadioGroup);
        sqmLSBContractionjointCrossSectionWearingcourseRadioGroup = (RadioGroup) findViewById(R.id.sqmLSBInProgressGradingFormContractionjointCrossSectionWearingcourseRadioGroup);
    	sqmOverallGradeRadioGroup = (RadioGroup) findViewById(R.id.sqmLSBInProgressGradingFormOverallGradeRadioGroup);
	...
	public void onClick(View v) {
	    ...
	    if(v.getId() == R.id.sqmLSBInProgressGradingFormSaveBtn){
	    	   saveGradingValues();
		    }
	       
	    if(v.getId() == R.id.sqmLSBInProgressGradingFormCancelBtn){
	    	finish();
    		}
	...
	public void calculateOverAllGrading(){
		...
		RadioButton S = (RadioButton) findViewById(R.id.sqmLSBInProgressGradingFormOverallGradeRadio_S);
		RadioButton SRI = (RadioButton) findViewById(R.id.sqmLSBInProgressGradingFormOverallGradeRadio_SRI);
		RadioButton U = (RadioButton) findViewById(R.id.sqmLSBInProgressGradingFormOverallGradeRadio_U);
		RadioButton NA = (RadioButton) findViewById(R.id.sqmLSBInProgressGradingFormOverallGradeRadio_NA);
		
		RadioButton Contractionjoint_S = (RadioButton) findViewById(R.id.sqmLSBInProgressGradingFormContractionjointRadio_S);
		RadioButton Contractionjoint_SRI = (RadioButton) findViewById(R.id.sqmLSBInProgressGradingFormContractionjointRadio_SRI);
		RadioButton Contractionjoint_U = (RadioButton) findViewById(R.id.sqmLSBInProgressGradingFormContractionjointRadio_U);
		RadioButton Contractionjoint_NA = (RadioButton) findViewById(R.id.sqmLSBInProgressGradingFormContractionjointRadio_NA);
		
		RadioButton ApproachesstageIIandIII_S = (RadioButton) findViewById(R.id.sqmLSBInProgressGradingFormApproachesstageIIandIIIRadio_S);
		RadioButton ApproachesstageIIandIII_SRI = (RadioButton) findViewById(R.id.sqmLSBInProgressGradingFormApproachesstageIIandIIIRadio_SRI);
		RadioButton ApproachesstageIIandIII_U = (RadioButton) findViewById(R.id.sqmLSBInProgressGradingFormApproachesstageIIandIIIRadio_U);
		RadioButton ApproachesstageIIandIII_NA = (RadioButton) findViewById(R.id.sqmLSBInProgressGradingFormApproachesstageIIandIIIRadio_NA);
		...
		else if((selectvalueArrayList.get(0).equalsIgnoreCase("NA") && selectvalueArrayList.get(1).equalsIgnoreCase("NA") && selectvalueArrayList.get(2).equalsIgnoreCase("NA") && selectvalueArrayList.get(3).equalsIgnoreCase("NA")) && ( selectvalueArrayList.get(5).equalsIgnoreCase("NA") || selectvalueArrayList.get(6).equalsIgnoreCase("NA") || selectvalueArrayList.get(7).equalsIgnoreCase("NA")|| selectvalueArrayList.get(9).equalsIgnoreCase("NA")|| selectvalueArrayList.get(10).equalsIgnoreCase("NA")|| selectvalueArrayList.get(11).equalsIgnoreCase("NA")|| selectvalueArrayList.get(12).equalsIgnoreCase("NA"))){
				...
				public void onClick(DialogInterface dialog, int id) {
					...
					*/	ObservationDetailsDAO observationDetailsDAOObj = new ObservationDetailsDAO();
						...
						if(result == 0 || result == -1 ) {
							...
							final Intent intent = new Intent(SqmLSBInProgressGradingActivity.this,StandardMenuActivity.class);
